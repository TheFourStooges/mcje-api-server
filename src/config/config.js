...
const envVarsSchema = Joi.object()
  .keys({
    ...
    DATABASE_URL: Joi.string().description('Sequelize database URL'),
    SQL_DIALECT: Joi.string().description('Sequlize: dialect, see documentation'),
    SQL_HOST: Joi.string().description('Sequelize: server hostname/address'),
    SQL_DATABASE: Joi.string().description('Sequelize: database name'),
    SQL_USERNAME: Joi.string().description('Sequelize: database login username'),
    SQL_PASSWORD: Joi.string().description('Sequelize: database login password'),
